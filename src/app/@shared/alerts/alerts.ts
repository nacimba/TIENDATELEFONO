...
export async function formBasicDialog(
    ...
    return await swalWithBasicOptions(title, html).fire({
        ...
        preConfirm: () => {
            ...
            Swal.showValidationMessage('Tienes que añadir un género para poder guardar');
            return;
...
/*Creaamos como otra alerta de sweetalert2 para mostrar la información 
ojo sin async del elemento */
